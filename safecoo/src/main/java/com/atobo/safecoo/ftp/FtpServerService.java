...
public class FtpServerService extends Service implements Runnable {
	...
	public void run() {
		...
		// world
		(JXApplication.getInstance()).setupNotification(this);
	...
	public void cleanupAndStopService() {
		...
		releaseWifiLock();
		releaseWakeLock();
		JXApplication.getInstance().clearNotification(this);
	...
	public static InetAddress getLocalInetAddress() {
		...
		if (isConnectedUsingWifi()) {
			WifiManager wm = (WifiManager) JXApplication.getContext()
	...
	public static boolean isConnectedToLocalNetwork() {
		ConnectivityManager cm = (ConnectivityManager) JXApplication.getContext()
