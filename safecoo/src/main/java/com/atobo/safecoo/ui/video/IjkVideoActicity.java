...
import com.atobo.safecoo.common.MediaController;
import com.atobo.safecoo.view.PolyvAuditionView;
import com.atobo.safecoo.view.PolyvPlayerAdvertisementView;
import com.atobo.safecoo.view.PolyvPlayerFirstStartView;
import com.atobo.safecoo.view.PolyvQuestionView;
...
public class IjkVideoActicity extends AbstractBaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	setViewId(R.layout.video_small2);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
        if(event.KEYCODE_BACK!=keyCode){//取消返回变竖屏
