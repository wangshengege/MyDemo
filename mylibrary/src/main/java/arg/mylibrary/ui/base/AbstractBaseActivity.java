...
import arg.mylibrary.autolayout.AutoLayout;
import arg.mylibrary.autolayout.AutoLayoutActivity;
...
public abstract class AbstractBaseActivity extends AutoLayoutActivity implements JsonCallback {
	/** HYApplication对象 */
	protected YSApplication myApplication;
